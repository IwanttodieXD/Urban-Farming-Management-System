...
<body>
    <header>
        ...
        <div class="content">
            <div class="location">
                Herbs / <span class="currentlocation">Plants</span>
            </div>
        </div>
    </header>
    <div class="panel1">
        <form class="form1" action="/urbfrm/php/addplanth.php" method="POST">
            <div class="panel-header">Add Batch</div>
    
            <label for="plantname">Herbs</label>
            <select id="plantname" name="plant_name" required onchange="handlePlantSelection()">
                <option value="" disabled selected>Please Choose a Herb to Add</option>
                <option value="chocolate basil">Chocolate Basil</option>
        ...
        <form class="form1" id="searchForm">
            ...
            <select id="searchplantname" name="plant_name" required onchange="handlePlantUpdate()">
                <option value="" disabled selected>Please Choose a Herbs to Search/Update</option>
                <option value="chocolate basil">Chocolate Basil</option>
                <option value="dill">Dill</option>
                <option value="lavander">Lavander</option>
                <option value="rosemary">Rosemary</option>
    ...
    <div class="panel1">
        <form class="form2" action="/urbfrm/php/addplanth.php" method="POST">
    ...
    <table border="1">
        ...
        <tbody id="plantTableBody">
            ...
            $sql = "SELECT PlantName, BatchNum, NoSeedsPlanted, PlantingNote, PlantingDate, NoSeedsTransplanted, DateTransplanted, TransplantingNote, PotMixUsed FROM plantingrecords WHERE PlantType = 'Herbs' ORDER By BatchNum DESC";
    ...
    <div class="tablediv">
        ...
        <table border="1">
            ...
            $sql = "SELECT PlantName, PBatchNum, HBatchNum, DateOfHarvest, NoPlantsHarvested, Quantity, Remarks FROM harvestingrecords WHERE PlantType = 'Herbs' ORDER By HBatchNum DESC";
            $result = $conn->query($sql);
