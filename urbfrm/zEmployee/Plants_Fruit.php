...
<body>
    <header>
        ...
        <div class="content">
            <div class="location">
                Fruit Bearing / <span class="currentlocation">Plants</span>
            </div>
        </div>
    </header>
    <div class="panel1">
        <form class="form1" action="/urbfrm/php/addplantf.php" method="POST">
            ...
            <select id="plantname" name="plant_name" required onchange="handlePlantSelection()">
                <option value="" disabled selected>Please Choose a Fruit Bearing Crop to Add</option>
        ...
        <form class="form1" id="searchForm">
            ...
            <select id="searchplantname" name="plant_name" required onchange="handlePlantUpdate()">
                <option value="" disabled selected>Please Choose a Fruit Bearing Crops to Search</option>
                <option value="ampalaya">Ampalaya</option>
                <option value="bellpeper">Bellpeper</option>
                <option value="cherry tomato">Cherry Tomato</option>
                <option value="kalabasa">Kalabasa</option>
    ...
    <div class="panel1">
        <form class="form2" id="form2" action="/urbfrm/php/addplantf.php" method="POST">
        ...
        <form class="form2" action="/urbfrm/php/addplantf.php" method="POST">
...
<script>
    ...
    <table border="1">
        ...
        <tbody id="plantTableBody">
            ...
            $sql = "SELECT PlantName, BatchNum, NoSeedsPlanted, PlantingNote, PlantingDate, NoSeedsTransplanted, DateTransplanted, TransplantingNote, PotMixUsed FROM plantingrecords WHERE PlantType = 'Fruit' ORDER BY BatchNum DESC";
    ...
    <div class="tablediv">
        ...
        <table border="1">
            ...
            $sql = "SELECT PlantName, PBatchNum, HBatchNum, DateOfHarvest, NoPlantsHarvested, Quantity, Remarks FROM harvestingrecords WHERE PlantType = 'Fruit' ORDER BY HBatchNum DESC";
            $result = $conn->query($sql);
